function varargout = TipTracker_v4(varargin)
% TIPTRACKER_V4 MATLAB code for TipTracker_v4.fig
%      TIPTRACKER_V4, by itself, creates a new TIPTRACKER_V4 or raises the existing
%      singleton*.
%
%      H = TIPTRACKER_V4 returns the handle to a new TIPTRACKER_V4 or the handle to
%      the existing singleton*.
%
%      TIPTRACKER_V4('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TIPTRACKER_V4.M with the given input arguments.
%
%      TIPTRACKER_V4('Property','Value',...) creates a new TIPTRACKER_V4 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before TipTracker_v4_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to TipTracker_v4_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @TipTracker_v4_OpeningFcn, ...
    'gui_OutputFcn',  @TipTracker_v4_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% varargin   command line arguments to TipTracker_v4 (see VARARGIN)
...
function varargout = TipTracker_v4_OutputFcn(hObject, eventdata, handles)
...
handles.param.ch1_back = 1;
handles.param.ch2_back = 1;
handles.param.ch3_back = 1;
handles.param.ch4_back = 1;

% autofluorescence correction
handles.param.auto_corr_use = 0;
...
% tip profile
handles.param.tip_profile_average = 3;
...
set(handles.chk_filter_tophat, 'Value', handles.param.filter_tophat_use);

% update the background parameters
set(handles.pop_back_method, 'Value',find(strcmp(get(handles.pop_back_method,'String'),handles.param.back_method)))
set(handles.chk_ch1_back,'Value',handles.param.ch1_back)
set(handles.chk_ch2_back,'Value',handles.param.ch2_back)
set(handles.chk_ch3_back,'Value',handles.param.ch3_back)
set(handles.chk_ch4_back,'Value',handles.param.ch4_back)
...
for iC = 1:handles.nC
    ...
    if handles.param.(['ch' num2str(iC) '_back']) == 1
